...
generator.add(Dense(128*12*12, input_dim=randomDim, kernel_initializer=initializers.RandomNormal(stddev=0.02)))
...
discriminator.add(Conv2D(32, kernel_size=(8, 8), strides=(2, 2), padding='same', input_shape=(1, nx, ny), kernel_initializer=initializers.RandomNormal(stddev=0.02)))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
discriminator.add(Conv2D(64, kernel_size=(8, 8), strides=(2, 2), padding='same'))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
