...
generator.add(Conv2D(128, kernel_size=(6,6), padding='same', kernel_initializer=initializers.RandomNormal(stddev=0.01)))
generator.add(BatchNormalization(axis=1))
generator.add(Activation('relu'))
...
#generator.add(LeakyReLU(0.1))
generator.add(UpSampling2D(size=(2, 2)))
generator.add(Conv2D(64, kernel_size=(12, 12), padding='same'))
generator.add(BatchNormalization(axis=1))
generator.add(Activation('relu'))
#generator.add(LeakyReLU(0.1))
#generator.add(Dropout(0.1))
...
discriminator.add(Conv2D(128, kernel_size=(10, 10), strides=(2, 2), padding='same', 
...
discriminator.add(Conv2D(256, kernel_size=(8, 8), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
#discriminator.add(BatchNormalization(momentum=0.7))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.4))
