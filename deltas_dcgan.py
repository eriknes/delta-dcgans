...
#discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
discriminator.add(Conv2D(128, kernel_size=(5, 5), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
#discriminator.add(BatchNormalization(momentum=0.9))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
discriminator.add(Conv2D(256, kernel_size=(5, 5), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
#discriminator.add(BatchNormalization(momentum=0.9))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
