...
generator.add(Conv2D(128, kernel_size=(4,4), padding='same', kernel_initializer=initializers.RandomNormal(stddev=0.02)))
generator.add(Activation('relu'))
...
discriminator.add(Conv2D(16, kernel_size=(12, 12), strides=(2, 2), padding='same', 
...
#discriminator.add(LeakyReLU(0.2))
#discriminator.add(Dropout(0.3))
discriminator.add(Conv2D(32, kernel_size=(8, 8), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
#discriminator.add(BatchNormalization(momentum=0.9))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
discriminator.add(Conv2D(64, kernel_size=(4, 4), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
#discriminator.add(BatchNormalization(momentum=0.9))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Dropout(0.3))
